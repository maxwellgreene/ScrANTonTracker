...
class MaskRCNN():
    ...
    def mold_inputs(self, images):
        ...
        for image in images:
            ...
            if debugPrint: print("mindim: ",self.config.IMAGE_MIN_DIM)
            if debugPrint: print("maxdim: ",self.config.IMAGE_MAX_DIM)
            if debugPrint: print("mode: ",self.config.IMAGE_RESIZE_MODE)
    ...
    def unmold_detections(self, detections, mrcnn_mask, original_image_shape,
        ...
        if debugPrint: print("boxes from unmold detections: ",boxes)
        class_ids = detections[:N, 4].astype(np.int32)
        if debugPrint: print("class_ids1: ",class_ids)
        scores = detections[:N, 5]
        masks = mrcnn_mask[np.arange(N), :, :, class_ids]

        # Translate normalized coordinates in the resized image to pixel
        # coordinates in the original image before resizing
        if debugPrint: print("windowbefore: ",window)
        ...
        if debugPrint: print("boxes after denorm: ",boxes)
