...
ROOT_DIR = os.path.abspath(r"C:/Users/Max/Documents/GitHub/ScrANTonTracker/")
...
class BalloonDataset(utils.Dataset):
    ...
    def load_balloon(self, dataset_dir, subset):
        ...
        self.add_class("head",4,"head")
        self.add_class("thorax",3,"thorax")
        self.add_class("abdomen",2,"abdomen")
        ...
        for a in annotations:
            ...
            if type(a['Label']) is dict:
                polygons = [r for r in a['Label'].values()]
            else:
                polygons = [r for r in a['Label'].values()]
